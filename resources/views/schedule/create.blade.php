        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <div>
                    ...
                    <form action="{{ route('Schedule.store') }}" onsubmit="validateForm()" method="POST" enctype="multipart/form-data" id="form">
                        @csrf
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            name="transactiondate" value="{{ now()->format('Y-m-d') }}">
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{-- <input type="datetime-local" class="form-control" id="datepagi"
                                                            name="datepagi[]" value="{{ now()->setTimezone('T')->format('Y-m-dTh:m') }}"> --}}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    name="datesiang[]" value="{{ now()->setTimezone('T')->format('Y-m-dTh:m') }}"> --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    name="datemalam[]" value="{{ now()->setTimezone('T')->format('Y-m-dTh:m') }}"> --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="stardate"
                                                            name="stardate[]" value="{{ now()->setTimezone('T')->format('Y-m-dTh:m') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="disabledInput">Tanggal Akhir Minum Obat</label>
                                                    <input type="datetime-local" class="form-control" id="enddate"
                                                    name="enddate[]" value="{{ now()->setTimezone('T')->format('Y-m-dTh:m') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
